...
Los tiempos de procesamiento para encontrar el camino más corto se presentan a continuación\\

\begin{center}
 \includegraphics[width=12cm]{imgs/table_seconds.png}\\
 \footnotesize{Tiempos CPU con 1 a 16 threads. Comando usado:}\\
\end{center}

\begin{center}
 \includegraphics[width=12cm]{imgs/table_minutes.png}\\
 \footnotesize{Tiempos CPU con 1 a 16 threads. Comando usado:}\\
\end{center}
